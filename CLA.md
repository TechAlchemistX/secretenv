...
- (a) **Original work.** Each of Your Contributions is Your original creation, or You have sufficient rights to grant the rights in this Agreement. If Your Contribution includes third-party material, You identify it in the Contribution and explain any associated license or attribution requirements.
- (b) **Authority.** You are legally entitled to grant the above licenses. If Your employer(s) have rights to intellectual property You create that includes Your Contributions, You represent that You have received permission to make Contributions on behalf of that employer, that Your employer has waived such rights for Your Contributions to the Project, OR that Your employer has executed a separate Corporate CLA with the Project.
- (c) **Compliance.** Your Contribution does not knowingly violate any law or infringe any third party's rights.
- (d) **No warranties beyond above.** Except for the representations above, You provide Your Contributions "AS IS" without warranty of any kind, express or implied.

## 6. Governing Law

This Agreement is governed by the laws of the jurisdiction in which TechAlchemistX operates. Any disputes arising under this Agreement are subject to the exclusive jurisdiction of the courts in that jurisdiction.

## 7. Signing Mechanism

You signify agreement to this CLA by doing all of the following when submitting a Contribution:
...
Corporate contributors should additionally contact the Project maintainer to execute a Corporate CLA (out of scope for this document).

## 8. Changes to This Agreement

The Project may update this Agreement from time to time. Material changes will be announced in the repository's [CHANGELOG](CHANGELOG.md) and take effect for Contributions submitted after the effective date of the new version. Contributions submitted before the change remain governed by the version in effect at the time of submission.

---

If any clause of this Agreement is held unenforceable, the remainder of the Agreement remains in full force and effect.
