...
use secretenv_mcp::boundary::{
    ...
    ListAliasesResponse, ListBackendsResponse, PasswordManagerDetection, RedactStatusResponse,
    RegistryAliasesProbe, ResolveStatusRegistryProbe, ResolveStatusResponse, SetAliasResponse,
